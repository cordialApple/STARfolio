...
- [x] 5.3 Drill-down follow-ups ("what did you measure there?") triggered by vague/unquantified answers.
- [x] 5.4 Session persistence + history view (transcript, feedback recap); link answers to the bank experiences they used; flag "you told a story that isn't banked yet — capture it?" (feeds the Maintain loop).
- [x] 5.5 e2e (replay transport): scripted 3-question session; a deliberately vague answer must trigger a drill-down, and feedback must score all four rubric dimensions.
